...
class DataTrainingArguments:
    ...
    train_data_path: Optional[str] = field(
        default="./tasks/alpaca/alpaca_data_train.json", metadata={"help": "Path to the training data."}
    )
    eval_data_path: Optional[str] = field(
        default="./tasks/alpaca/alpaca_data_eval.json", metadata={"help": "Path to the evaluating data."}
    )
