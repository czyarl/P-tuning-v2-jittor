...
from transformers import TrainingArguments, EvalPrediction, get_linear_schedule_with_warmup
...
class BaseTrainer:
    def __init__(self, model, args: TrainingArguments, tokenizer, optimizer=None, lr_scheduler=None, 
        ...
        tot_steps = args.num_train_epochs * len(train_dataset) // args.train_batch_size
        self.lr_scheduler = lr_scheduler or get_linear_schedule_with_warmup(self.optimizer, num_training_steps=tot_steps, num_warmup_steps=tot_steps*0.1)
    ...
    def train(self, num_epochs=3, resume_from_checkpoint=None, last_checkpoint=None):
        ...
        # print(f"train ds: {self.train_dataset[0:2]}")
        # print(type(self.train_dataset))
        # print(type(self.train_dataset[0:2]))
        ...
        for epoch in range(int(num_epochs)):
            ...
            avg_train_loss = running_loss / running_item
